node{
  ...
  stage('Docker Build, Push'){
    ...
    stage('Deploy on K8s'){
        ...
        sh "/usr/local/bin/ansible-playbook -vvvv /Users/subrat/.jenkins/workspace/pipeline_dfly-app/deploy2.yml  --user=root --extra-vars ImageName=${ImageName} --extra-vars imageTag=${ImageTag}"
    }
  //} 
  //catch (err) {
